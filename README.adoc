...
| 1    | link:src/main/java/exercice/efficacite_meilleur.java[efficacite_meilleur java]| Java     | Efficacité | Meilleur
| 2    | link:src/main/java/exercice/efficacite_pire.java[efficacite_pire java]| Java     | Efficacité | Pire
| 3    | link:src/main/java/exercice/simplicite_meilleur.java[simplicite_meilleur java]| Java     | Simplicité | Meilleur
| 4    | link:src/main/java/exercice/simplicite_pire.java[simplicite_pire java]| Java     | Simplicité | Pire
| 5    | link:src/main/java/exercice/sobriete_meilleur.java[sobriete_meilleur java]| Java     | Sobriété Numérique | Meilleur
| 6    | link:src/main/java/exercice/sobriete_pire.java[sobriete_pire java]| Java     | Sobriété Numérique | Pire
|==========================================================================
